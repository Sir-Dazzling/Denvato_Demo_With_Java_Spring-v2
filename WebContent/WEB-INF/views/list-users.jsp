...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
	...
	<h3 class="text-center" style="margin-top: 10vh; ">All User Accounts</h3>
	...
	<section id="home">
		<div class="container-fluid" style="margin-top: -55vh;">
			<div class="row">
				<div class="col">
				<input style="margin-right: 90vw;" type="button" value="Add User" onclick="window.location.href = 'showFormForAddingUser'; return false;"
				class="add-button"/>
					<table class="table table-striped">
  					<thead class="thead-dark">
    					<tr>
      						...
      						<th scope="col">User Privileges</th>
  					...
  					<c:forEach var="tempUser" items="${users}">
  						<!-- constructing an update link with customer username -->
							<c:url var="updateLink" value="/admin/showFormForUserUpdate">
								<c:param name="username" value="${tempUser.username}"></c:param>
							</c:url>
    					...
    					<tr>
      						<th scope="row">${tempUser.username}</th>
      						<th scope="row">${tempUser.password}</th>
      						<th scope="row">${tempUser.firstName}</th>
      						<th scope="row">${tempUser.lastName}</th>
      						<th scope="row">${tempUser.email}</th>
      						<th scope="row">${tempUser.gender}</th>
      						<th scope="row">${tempUser.phoneno}</th>
      						<th scope="row">${tempUser.userAuthorities.authority}</th>
      						<td>
